...
namespace VoxelImporter
{
    public class VoxelChunksObjectCore : VoxelBaseCore
    {
            ...
            int chunkCount = 0;
            {
                ...
                for (int i = 0; i < chunkDataList.Count; i++)
                {
                    ...
                    if (chunkObject == null)
                    {
                        ...
                        chunkObject.transform.localPosition = Vector3.Scale(voxelObject.localOffset + chunkDataList[i].area.GetPivot(voxelObject.chunkPivotT), voxelObject.importScale);
                    ...
                    controller.basicOffset = Vector3.Scale(voxelObject.localOffset + chunkDataList[i].area.GetPivot(voxelObject.chunkPivotT), voxelObject.importScale);
                    chunkCount++;
                }
                if (chunkObjectsUpdate)
                {
        ...
        protected override bool CreateMesh()
        {
            ...
            DisplayProgressBar("Create Face Area Table");
            {
                for (int i = 0; i < chunkDataList.Count; i++)
                {
            ...
            DisplayProgressBar("Create Mesh");
            {
                if (voxelObject.materialMode == VoxelChunksObject.MaterialMode.Combine)
                {
                    ...
                    if (voxelObject.importMode == VoxelBase.ImportMode.LowPoly)
                    {
                        ...
                        for (int i = 0; i < chunkDataList.Count; i++)
                        {
                            ...
                            chunkDataList[i].chunkObject.mesh = CreateMeshOnly(chunkDataList[i].chunkObject.mesh, chunkDataList[i].faceAreaTable, voxelObject.atlasTexture, chunkDataList[i].atlasRects, atlasRectTable, -(voxelObject.localOffset + chunkDataList[i].area.GetPivot(voxelObject.chunkPivotT)), out chunkDataList[i].chunkObject.materialIndexes);
                        }
                    }
                    else
                    {
                        for (int i = 0; i < chunkDataList.Count; i++)
                        {
                            chunkDataList[i].chunkObject.mesh = CreateMeshOnly(chunkDataList[i].chunkObject.mesh, chunkDataList[i].faceAreaTable, voxelObject.atlasTexture, chunkDataList[i].atlasRects, chunkDataList[i].atlasRectTable, -(voxelObject.localOffset + chunkDataList[i].area.GetPivot(voxelObject.chunkPivotT)), out chunkDataList[i].chunkObject.materialIndexes);
                        }
                    }
                    {
                ...
                else if (voxelObject.materialMode == VoxelChunksObject.MaterialMode.Individual)
                {
                    ...
                    for (int i = 0; i < chunkDataList.Count; i++)
                    {
                        chunkDataList[i].chunkObject.mesh = CreateMeshOnly(chunkDataList[i].chunkObject.mesh, chunkDataList[i].faceAreaTable, chunkDataList[i].chunkObject.atlasTexture, chunkDataList[i].atlasRects, chunkDataList[i].atlasRectTable, -(voxelObject.localOffset + chunkDataList[i].area.GetPivot(voxelObject.chunkPivotT)), out chunkDataList[i].chunkObject.materialIndexes);
                    }
