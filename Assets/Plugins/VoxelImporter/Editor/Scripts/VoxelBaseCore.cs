...
namespace VoxelImporter
{
    public abstract class VoxelBaseCore
    {
        ...
        private class LowPolyTextureBuffer
        {
        ...
        protected bool CreateTexture_LowPoly(VoxelData.FaceAreaTable faceAreaTable, ref AtlasRectTable atlasRectTable, ref Texture2D atlasTexture, ref Rect[] atlasRects)
        {
            ...
            List<LowPolyTextureBuffer> bufferList = new List<LowPolyTextureBuffer>();
            Dictionary<IntVector2, List<LowPolyTextureBuffer>> bufferDic = new Dictionary<IntVector2, List<LowPolyTextureBuffer>>();
